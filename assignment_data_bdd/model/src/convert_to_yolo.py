...
def main():
    ...
    parser.add_argument('--data-root', type=str, 
                        default='/Users/ayushsoral/Desktop/code/anusha_assmt/assignment_data_bdd/data_analysis/data',
                        help='Root directory of BDD100K dataset')
    parser.add_argument('--output-root', type=str,
                        default='/Users/ayushsoral/Desktop/code/anusha_assmt/assignment_data_bdd/data_analysis/data/bdd100k_labels_yolo',
